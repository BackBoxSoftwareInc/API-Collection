...
It is strongly recommended you use the BackBox UI to generate an API Key, and use that for authentication here. You will see the authorization at the top level is set up for API key, and all calls below that inherit those values.
